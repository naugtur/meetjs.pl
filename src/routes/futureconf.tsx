...
import { Calendar, MapPin, ExternalLink, Star } from '@/lib/lucide';

export default function FutureConfPage() {
  return (
    <div class="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50">
      {/* Hero Section */}
      <section class="relative overflow-hidden bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-600 text-white">
        ...
        <div class="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div class="text-center">
            ...
            <div class="mb-8 flex flex-wrap justify-center gap-6 text-lg">
            ...
            <div class="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
              <a
                ...
                target="_blank"
                rel="noopener"
                class="inline-flex items-center rounded-lg bg-white px-8 py-4 text-lg font-semibold text-purple-600 transition-all hover:scale-105 hover:bg-purple-50"
              >
                Get Group Discount
      ...
      <section class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="grid gap-12 lg:grid-cols-2">
          ...
          <div class="rounded-2xl bg-gradient-to-br from-purple-100 to-indigo-100 p-8">
            <h2 class="mb-6 text-3xl font-bold text-gray-900">
              How to Get Up to 50% Off
            </h2>
            <div class="space-y-4">
              <div class="flex items-start">
                <div class="mr-4 flex h-8 w-8 items-center justify-center rounded-full bg-purple-600 font-bold text-white">
                  1
                </div>
                <div>
              ...
              <div class="flex items-start">
                ...
                <div>
                  <h3 class="font-semibold text-gray-900">Buy Your Ticket</h3>
                  <p class="text-gray-600">Purchase your Future ticket</p>
                </div>
              </div>
              <div class="flex items-start">
                <div class="mr-4 flex h-8 w-8 items-center justify-center rounded-full bg-purple-600 font-bold text-white">
        ...
        <div class="mt-16">
          <div class="relative overflow-hidden rounded-2xl">
            ...
            <div class="absolute bottom-6 left-6 text-white">
              <p class="text-lg font-semibold">Experience the Energy</p>
                ...
                each={[
                  {
                    ...
                    image:
                      'https://futureconf.tech/assets/speakers/vladimir.jpeg',
                  },
                  {
                    ...
                    image:
                      'https://futureconf.tech/assets/speakers/mateusz.webp',
                  },
                  {
                    name: 'Sacha Bron',
                  ...
                  },
                  {
                    ...
                    image:
                      'https://futureconf.tech/assets/speakers/bartosz.jpeg',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    image:
                      'https://futureconf.tech/assets/speakers/ziemowit.webp',
                  },
                  {
                    ...
                    image:
                      'https://futureconf.tech/assets/speakers/zbigniew.jpeg',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    image:
                      'https://futureconf.tech/assets/speakers/smyrdek.webp',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    company: 'Docker',
                    image:
                      'https://futureconf.tech/assets/speakers/gronowski.jpg',
                  },
                  {
                    ...
                    company: 'APN Promise',
                    image:
                      'https://futureconf.tech/assets/speakers/kuba_b.webp',
                  },
                  {
                    name: 'Mateusz Zapart',
                    ...
                    company: 'APN Promise',
                    image:
                      'https://futureconf.tech/assets/speakers/mateusz_z.webp',
                  },
                ]}
              >
                {(speaker, index) => (
                  <div class="rounded-lg bg-white p-6 shadow-md transition-all hover:scale-105 hover:shadow-lg">
                    ...
                    <div class="text-center">
                      ...
                      <div class="mb-1 text-sm text-purple-600">
                        {speaker.role}
                      </div>
          ...
          <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <div class="relative overflow-hidden rounded-lg">
              <img
                ...
                width={400}
                height={192}
                class="h-48 w-full object-cover transition-transform hover:scale-110"
              />
              <div class="absolute inset-0 bg-gradient-to-t from-black/30 to-transparent"></div>
              <div class="absolute bottom-3 left-3 text-sm font-medium text-white">
                Inspiring Speakers
              </div>
            </div>
            <div class="relative overflow-hidden rounded-lg">
        ...
        {/* CTA Section */}
        <div class="mt-16 rounded-2xl bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-600 p-8 text-center text-white">
          ...
          <div class="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            <a
              href="/discounts"
              class="inline-flex items-center text-purple-100 hover:text-white"
            >
              View All Discounts
