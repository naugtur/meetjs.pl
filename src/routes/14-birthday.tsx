...
function ShareButton(props: {
  ...
  return (
    <button
      ...
      class={`rounded-full px-6 py-2 font-semibold text-white transition-transform hover:scale-105 ${props.platform === 'twitter' ? 'bg-[#1DA1F2]' : ''} ${props.platform === 'linkedin' ? 'bg-[#0A66C2]' : ''} ${props.platform === 'facebook' ? 'bg-[#1877F2]' : ''} `}
    >
      {props.children}
    </button>
  );
...
export default function Page() {
  ...
  return (
    <>
      <BirthdayConfetti />
      <div class="container relative mx-auto max-w-4xl py-16">
        <div class="mb-12 text-center">
          <h1 class="mb-4 bg-gradient-to-r from-yellow-400 via-red-500 to-purple-600 bg-clip-text text-6xl font-bold text-transparent">
            🎉 14 Years of meet.js! 🎉
          </h1>
        ...
        <div class="mb-8 space-y-4">
          ...
          <div class="my-6">
            <img
              ...
              width={400}
              height={300}
              class="mx-auto mb-2 rounded-lg shadow-lg"
            />
          ...
          <div class="rounded-r-lg border-l-4 border-blue-600 bg-gray-50 p-4 shadow-sm">
        ...
        <div class="mb-12 grid grid-cols-2 gap-6 text-center md:grid-cols-4">
          <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-lg">
            <div class="mb-2 text-3xl font-bold text-blue-600">14</div>
            <div class="text-gray-600">Years Strong</div>
          </div>
          <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-lg">
            <div class="mb-2 text-3xl font-bold text-blue-600">8+</div>
            <div class="text-gray-600">Active Cities</div>
          </div>
          <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-lg">
            <div class="mb-2 text-3xl font-bold text-blue-600">500+</div>
            <div class="text-gray-600">Meetups Held</div>
          </div>
          <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-lg">
            <div class="mb-2 text-3xl font-bold text-blue-600">1000+</div>
            <div class="text-gray-600">Talks Given</div>
          </div>
        </div>
        ...
        <div class="my-12">
          ...
          <div class="space-y-4">
            <div class="flex items-start">
              <div class="w-24 flex-shrink-0 font-bold text-blue-600">2011</div>
              <div class="flex-grow">First meet.js in Poznań</div>
            </div>
            <div class="flex items-start">
              <div class="w-24 flex-shrink-0 font-bold text-blue-600">2012</div>
              <div class="flex-grow">Expansion to Warsaw and Wrocław</div>
            </div>
            <div class="flex items-start">
              <div class="w-24 flex-shrink-0 font-bold text-blue-600">2015</div>
              <div class="flex-grow">First meet.js Summit conference</div>
            </div>
            <div class="flex items-start">
              <div class="w-24 flex-shrink-0 font-bold text-blue-600">2024</div>
              <div class="flex-grow">
        ...
        <div class="mb-12 grid grid-cols-1 gap-8 md:grid-cols-2">
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-lg">
            <h2 class="mb-4 text-2xl font-semibold text-blue-600">
              Our Impact
            </h2>
          ...
          <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-lg">
            <h2 class="mb-4 text-2xl font-semibold text-blue-600">Our Pride</h2>
            <ul class="list-disc space-y-2 pl-6">
        ...
        <div class="mb-12 text-center">
          <h2 class="mb-6 text-3xl font-semibold">Thank You!</h2>
        ...
        <div class="text-center">
          <h3 class="mb-4 text-xl font-semibold">Join the Celebration!</h3>
          <p class="mb-4">
        ...
        <div class="mt-12 text-center">
          <h3 class="mb-6 text-2xl font-semibold">Share the Celebration! 🎈</h3>
