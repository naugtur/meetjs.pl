  ...
  return (
    <div class="container mx-auto max-w-6xl py-16">
      ...
      <div class="mb-12 text-center">
        <h1 class="mb-4 text-4xl font-bold">{t('organizer.hub_page_title')}</h1>
      ...
      {/* Quick Actions */}
      <div class="mb-16 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <a
          href="/how-to-become-an-organizer"
          class="rounded-lg border bg-blue-50 p-4 text-center transition-colors hover:bg-blue-100"
        >
        ...
        <a
          href="/events"
          class="rounded-lg border bg-green-50 p-4 text-center transition-colors hover:bg-green-100"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          class="rounded-lg border bg-purple-50 p-4 text-center transition-colors hover:bg-purple-100"
        >
          <ExternalLink class="mx-auto mb-2 h-6 w-6 text-purple-600" />
        ...
        <a
          ...
          class="rounded-lg border bg-orange-50 p-4 text-center transition-colors hover:bg-orange-100"
        >
          <Mail class="mx-auto mb-2 h-6 w-6 text-orange-600" />
      ...
      <section id="tools" class="mb-16">
        <div class="mb-8 text-center">
          ...
          <p class="text-gray-600">{t('organizer.tools_section.subtitle')}</p>
        </div>
        ...
        <div class="grid gap-8 md:grid-cols-2">
          <div class="rounded-lg border bg-white p-6 shadow-sm">
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              class="inline-flex items-center gap-2 rounded-md bg-purple-600 px-4 py-2 text-white transition-colors hover:bg-purple-700"
            >
      ...
      <section id="assets" class="mb-16">
        <div class="mb-8 text-center">
          ...
          <p class="text-gray-600">{t('organizer.assets_section.subtitle')}</p>
        </div>
      ...
      <div class="rounded-lg bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-white">
        <div class="text-center">
          ...
          <a
            href="/how-to-become-an-organizer"
            class="inline-flex items-center rounded-md bg-white px-6 py-3 text-blue-600 transition-colors hover:bg-gray-100"
          >
