...
export const COMMUNITY_PARTICIPATION: CommunityItem[] = [
  ...
  },
  {
    ...
    title: 'State of React 2025 Results',
    description:
      "The State of React 2025 survey results are finally here! Although participation was a little lower than expected, the survey still surfaced quite a few interesting insights. Check out Josh W. Comeau's Bluesky recap thread for a great TL;DR. Brought to you by Sacha Greif and Devographics, with support from Google Chrome team, TokyoDev, Frontend Masters, Algolia, Storyblok, Polypane, and WebStorm.",
    url: 'https://2024.stateofreact.com',
    type: 'survey',
    status: 'completed',
    ...
    organization: 'Devographics',
    impact:
      'Discover the latest React trends, tool adoption, and community insights to make informed decisions about your stack.',
    ctaText: 'View Results',
    featured: true,
    image: 'https://assets.devographics.com/surveys/react2025.png',
    tags: ['React', 'Survey', 'Results', 'Community', 'Trends', 'Ecosystem'],
  },
  {
    id: 'skkp-2025',
