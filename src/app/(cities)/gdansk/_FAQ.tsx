...
export const GdanskFAQ: FAQQuestion[] = [
	...
	},
	{
		...
		answer: (
			<>
				We welcome speakers of all experience levels! If you&apos;d like to share your knowledge, please reach out to us at{' '}
				<a
					href="mailto:gdansk@meetjs.pl"
	...
	},
	{
		...
		answer: (
			<>
				Yes, registration is required for each event. You can sign up through our{' '}
				<a
