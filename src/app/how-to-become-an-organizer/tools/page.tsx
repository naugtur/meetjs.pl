...
export default async function OrganizerToolsPage() {
  ...
  return (
    <div className="container mx-auto max-w-3xl py-16">
      <h1 className="mb-4 text-4xl font-bold">{t('organizer.tools_page_title')}</h1>
      ...
      <section className="mb-12 rounded-lg border bg-white p-6 shadow-sm">
        <div className="mb-4 flex items-center gap-3">
          ...
          <h2 className="text-2xl font-semibold">{t('organizer.generator_title')}</h2>
        </div>
        <p className="mb-6 text-gray-600">{t('organizer.generator_description')}</p>
        <a
      ...
      <div className="text-sm text-gray-600">
        ...
        <Link href="/how-to-become-an-organizer" className="underline hover:no-underline">
