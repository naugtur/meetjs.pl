    ...
    <>
      ...
      <div className="container relative mx-auto max-w-4xl py-16">
        <div className="mb-12 text-center">
          <h1 className="to-purple-600 mb-4 bg-gradient-to-r from-yellow-400 via-red-500 bg-clip-text text-6xl font-bold text-transparent">
            🎉 14 Years of meet.js! 🎉
          </h1>
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="border-blue-600 rounded-r-lg border-l-4 bg-gray-50 p-4 shadow-sm">
            <p className="text-sm leading-relaxed text-gray-700">
              ...
              <a
                ...
                className="text-blue-600 hover:text-blue-800 inline-flex items-center font-medium transition-colors duration-200"
              >
        ...
        <div className="mb-12 grid grid-cols-2 gap-6 text-center md:grid-cols-4">
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-lg">
            <div className="text-blue-600 mb-2 text-3xl font-bold">14</div>
            <div className="text-gray-600">Years Strong</div>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-lg">
            <div className="text-blue-600 mb-2 text-3xl font-bold">8+</div>
            <div className="text-gray-600">Active Cities</div>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-lg">
            <div className="text-blue-600 mb-2 text-3xl font-bold">500+</div>
            <div className="text-gray-600">Meetups Held</div>
          </div>
          <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-lg">
            <div className="text-blue-600 mb-2 text-3xl font-bold">1000+</div>
        ...
        <div className="my-12">
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              <div className="text-blue-600 w-24 flex-shrink-0 font-bold">
                2011
              </div>
