...
const timelineEvents = [
  ...
  },
  {
    year: '1999',
    title: 'ECMAScript 3',
    description: 'Major update introducing regular expressions, try/catch, and more robust error handling.',
    icon: '🔧'
  },
  {
    year: '2005',
  ...
  },
  {
    year: '2008',
    title: 'V8 Engine',
    description: 'Google releases the V8 JavaScript engine with Chrome, dramatically improving performance.',
    icon: '⚡'
  },
  {
    year: '2009',
  ...
  },
  {
    year: '2012',
    title: 'TypeScript',
    description: 'Microsoft introduces TypeScript, adding static typing to JavaScript.',
    icon: '📘'
  },
  {
    year: '2013',
  ...
  },
  {
    year: '2014',
    title: 'Vue.js',
    description: 'Evan You creates Vue.js, offering a progressive framework for building user interfaces.',
    icon: '💚'
  },
  {
    year: '2015',
  ...
  },
  {
    year: '2016',
    title: 'Angular 2',
    description: 'Complete rewrite of AngularJS using TypeScript, introducing component-based architecture.',
    icon: '🔺'
  },
  {
    year: '2017',
    title: 'WebAssembly',
    description: 'WebAssembly becomes a web standard, allowing near-native performance in browsers.',
    icon: '🔥'
  },
  {
    year: '2018',
    title: 'React Hooks',
    description: 'React introduces Hooks, revolutionizing state management in functional components.',
    icon: '🪝'
  },
  {
    year: '2020',
    title: 'JavaScript Everywhere',
    description: 'JavaScript dominates web development with frameworks like React, Vue, and Angular. Node.js powers backend services, and JavaScript runs on mobile, desktop, and IoT devices. It&#39;s truly everywhere in the tech stack.',
    icon: '🌐'
  },
  {
    year: '2021',
    title: 'ES2021',
    description: 'New features including logical assignment operators, numeric separators, and Promise.any().',
    icon: '✨'
  },
  {
    year: '2022',
    title: 'Bun Runtime',
    description: 'Bun is released as a fast all-in-one JavaScript runtime, bundler, and package manager.',
    icon: '🍞'
  },
  {
    year: '2025',
    title: 'JavaScript at 30',
    description: 'JavaScript celebrates 30 years of powering the web and beyond! From simple scripts to full-stack applications.',
    highlight: true,
    icon: '🎉'
  }
];
...
const JavaScriptTimeline = () => {
  ...
  const filteredEvents = timelineEvents.filter(event => {
    ...
    if (filter === 'frameworks' && ['2006', '2010', '2013', '2014', '2016'].includes(event.year)) return true;
    ...
    <div className={styles.timelineContainer}>
      ...
      <div className={styles.timeline}>
        {filteredEvents.map((event, index) => (
          ...
          >
            <div className={styles.timelineDot}><span className={styles.icon}>{event.icon}</span></div>
