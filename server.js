...
// (with serverFunctions enabled) serves the `/_server` endpoint too.
...
function webRequest(req, res) {
  ...
  // cancel streamed renders and in-flight work.
...
async function sendWebResponse(res, response) {
  ...
  try {
    while (true) {
      ...
      // memory when the client reads slowly.
...
const server = createServer(async (req, res) => {
  ...
  try {
    ...
    // conventionally the platform's raw request as `nativeEvent`.
